from dash import dcc, page_container, Input, Output, State, callback, clientside_callback, ALL, Patch, callback_context
        ...
        [
            dmc.Group(
                [
                    ...
                    dcc.Link(dmc.Title('OPENDATA', c='blue'), href='/', style={'textDecoration': 'none'}),
                ]
            ),
            theme_toggle(),
        ],
